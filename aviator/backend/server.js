...
async function CreateNewRound() {
    ...
    const event = {"result":{ "gameId": GameID, "gameName": GameName, "tableId": TableID, "tableName": TableName, "roundID": rId, "roundStatus": roundStat, "betStatus": betStat, "outcome": crashresult}};
